...
read stack1
aws cloudformation create-stack --stack-name $stack1 --template-body file://csye6225-cf-application.json --parameters file://parameters2.json --capabilities CAPABILITY_NAMED_IAM
